...
bool W25qxx_Init(void)
{
	...
	uint32_t id;
#if (_W25QXX_DEBUG == 1)
	HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Init Begin...\r\n",50,100);
#endif
	id = W25qxx_ReadID();
#if (_W25QXX_DEBUG == 1)
	sprintf(ch,"w25qxx ID:0x%X\r\n",id);
	HAL_UART_Transmit(&huart1,(uint8_t *)ch,50,100);
#endif
...
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q512\r\n",50,100);
#endif
		break;
	case 0x19: // 	w25q256
		w25qxx.ID = W25Q256;
...
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q256\r\n",50,100);
#endif
		break;
	case 0x18: // 	w25q128
		w25qxx.ID = W25Q128;
...
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q128\r\n",50,100);
#endif
		break;
	case 0x17: //	w25q64
		w25qxx.ID = W25Q64;
...
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q64\r\n",50,100);
#endif
		break;
	case 0x16: //	w25q32
		w25qxx.ID = W25Q32;
...
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q32\r\n",50,100);
#endif
		break;
	case 0x15: //	w25q16
		w25qxx.ID = W25Q16;
...
#if (_W25QXX_DEBUG == 1)
	HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q16\r\n",50,100);
#endif
		break;
	case 0x14: //	w25q80
		w25qxx.ID = W25Q80;
...
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q80\r\n",50,100);
#endif
		break;
	case 0x13: //	w25q40
		w25qxx.ID = W25Q40;
		w25qxx.BlockCount = 8;
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q40\r\n",50,100);
#endif
		break;
	case 0x12: //	w25q20
		w25qxx.ID = W25Q20;
		w25qxx.BlockCount = 4;
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Chip: w25q10\r\n",50,100);
#endif
		break;
	case 0x11: //	w25q10
		w25qxx.ID = W25Q10;
	...
	default:
#if (_W25QXX_DEBUG == 1)
		HAL_UART_Transmit(&huart1,(uint8_t *)"w25qxx Unknown ID\r\n",50,100);
#endif
		w25qxx.Lock = 0;
		return false;
	}
...
#if (_W25QXX_DEBUG == 1)
	sprintf((char *)ch,"w25qxx Page Size: %d Bytes\r\n",w25qxx.PageSize);
	HAL_UART_Transmit(&huart1,ch,50,1000);
	sprintf((char *)ch,"w25qxx Page Count: %d\r\n",w25qxx.PageCount);
	HAL_UART_Transmit(&huart1,ch,50,1000);
	sprintf((char *)ch,"w25qxx Sector Size: %d Bytes\r\n", w25qxx.SectorSize);
	HAL_UART_Transmit(&huart1,ch,50,1000);
	sprintf((char *)ch,"w25qxx Sector Count: %d\r\n", w25qxx.SectorCount);
	HAL_UART_Transmit(&huart1,ch,50,1000);
	sprintf((char *)ch,"w25qxx Block Size: %d Bytes\r\n", w25qxx.BlockSize);
	HAL_UART_Transmit(&huart1,ch,50,1000);
	sprintf((char *)ch,"w25qxx Block Count: %d\r\n", w25qxx.BlockCount);
	HAL_UART_Transmit(&huart1,ch,50,1000);
	sprintf((char *)ch,"w25qxx Capacity: %d KiloBytes\r\n", w25qxx.CapacityInKiloByte);
	HAL_UART_Transmit(&huart1,ch,50,1000);
	sprintf((char *)ch,"w25qxx Init Done\r\n");
	HAL_UART_Transmit(&huart1,ch,50,1);
#endif
	w25qxx.Lock = 0;
	return true;
}
